...
Distance sampling models have been used for estimating animal abundance in a wide range of contexts and for a variety of taxa (+ref). In recent years, the framework has been extended and also applied for estimating changes in abundance over time in open populations by embedding a hidden state model representing population dynamics [@moore2011; @sollmann2015]. 
