...
pkg.list <- c("coda", "colorspace", "cowplot", "EnvStats", "extraDistr", 
              ...
              "MCMCvis", "paletteer", "parallel", "qs", "reshape2", "RJSONIO", 
              "sf", "see", "targets", "terra", "tidybayes", 
              "tidyverse", "tmap", "viridis", "visNetwork")
...
Finally, there are a couple of follow-up analyses based on the posterior distributions from the model.
