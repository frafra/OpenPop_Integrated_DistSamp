...
-   Outlook: integration with / coupling to models for harvest to develop tools for (automatic) calculation of e.g. hunting quotas
    ...
    The framework used in our study can be adapted to include the effects of management actions and harvest. Harvest effects on willow ptarmigan has been studied yet uncertainties still exist [@sandercock_etal2011; @Aanes_Engen_SÆther_Willebrand_Marcström_2002; @pedersen2004; @willebrand2001]. Also, there is a dearth of empirical information about the effects of harvest on many exploited species despite decades of continued exploitation.
