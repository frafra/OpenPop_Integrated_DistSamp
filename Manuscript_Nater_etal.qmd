...
The highest population growth rates were estimated for areas with relatively low population densities across latitudes but we did not find evidence for a strong association between population growth rates and population densities overall ([@fig-paramCorrs] A). <!-- Indicate that this is just for the four most recent years. Same for figure below -->
...
<!-- ERLEND: I'm not sure if we want to go this way. The density the last few years is hard to interpret, given that there is so much temporal variation in densities. Also, growth during last four years might very well be related to cycle phase rather than spatial variation in demography. If we had included data until 2023, the density in Northern Norway would have come out as much higher, whereas many areas further south had very low density. I suggest we keep this part to a minimum, as there are many other intersting aspects to focus on -->

<!-- Erlend will probably have better ideas than I.-->

Density dependence is an important process to understand in ecology but more so for exploited species like willow ptarmigan [@andrewartha1954; @sandercock_etal2011; @aanes2002; @willebrand2001]. Negative density dependence has been found in several gallinaceous birds such as northern bobwhites *Colinus virginianus* [@mcconnell2018], *Perdix perdix* [@bro2003], and wild turkeys *Meleagris gallopavo* [@mcghee2007]). While we found the highest population growth rates in areas with relatively low density, and relatively low growth rates in high-density areas [@fig-paramCorrs A], our analysis did not provide evidence for a strong relationship between density and growth rates across space. However, this is unsurprising as we did find substantial spatial differences in demography, which suggests that carrying capacity too varies over space. Also, support for density dependence in willow ptarmigan has been mixed. @myrberget1988 observed no change in productivity despite a 50% decrease in abundance. Conversely, @pedersen2004 found strong overwinter negative density dependence and they posited that immigration was the vital rate that responded to changes in density. In @bowler2020, density dependence was included as a Gompertz form of density dependence (i.e. linear relationship betwee log popualtion size and log($\lambda$)), but without specifying which vital rate was affected by density dependence. Low survival rates appeared to have a one-year lag following abundance peaks. This pattern could be a result of negative density dependence that went undetected when looking at the ensemble of samples across the 41 areas. <!-- A suggested mechanism: If abundance peaks are related to years with high recruitment and high rodent abundance (in general), then predation on all life stages might be higher the year after due to chrash in the roden population. This is an indirect form for dd, but might still manifest as dd in the data. --> Negative density dependence has been shown in willow ptarmigan populations which may explain explain reduced survival following years with elevated densities [@pedersen2004]. Future work should explore different forms of density dependence, diferent time-lags, and the possibility for non-linear effects.

<!--# Not happy with the DD para yet but I can work on Jan 11 -->
...
<!-- Funnily enough, I have been suggesting to Erlend that we should have a master student to analyze the effect of dog breed on detection probability :-P -->

<!-- Only speculation, and no references to show to. But much of the willow ptarmigan habiat in Northern Norway is located in birch forest, so perhaps the habitat is more closed compared to souther norway ptarmigan habitat? Second, if (not sure if this is the case) the habitat is more rugged (as might be on the coast in Northern Norway) detections are probably lower. Third - clusters are smaller in North (ref lower recruitement), which might affect detection probabilities.  -->
...
The raw data from the line transect surveys is deposited on GBIF and can be accessed freely via the Living Norway Data Portal (https://data.livingnorway.no/). The work presented above is based on versions 1.7, 1.8, and 1.12 for the datasets from Fjellstyrene (key b49a2978-0e30-4748-a99f-9301d17ae119), Statskog (key 6a948a1c-7e23-4d99-b1c1-ec578d0d3159), and FeFo (key c47f13c1-7427-45a0-9f12-237aad351040), respectively. <!-- I thinbk it is better to cite the datasets (with doi and all that) rather than the key. That way, the citation and data use will be tracked by GBIF (and Living Norway) -->
