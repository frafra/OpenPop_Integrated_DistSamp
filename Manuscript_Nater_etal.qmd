...
of annual survival, i.e. lower recruitment rates co-occurring with higher survival rates and vice-versa [@fig-pVRB; @fig-paramCorrs B). Across all areas and years, average recruitment rate was `r R.hyper.mean`. Unlike for survival, the model predicted similar magnitudes of spatial and temporal variation (random effect SDs of `r R.sd.spatial` and `r R.sd.temporal`, respectively), and about twice as much residual variation (`r R.sd.residual`).  
